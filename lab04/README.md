...
```
If you are having trouble with the starter you can check the following <big><pre>[documentation](https://github.com/dreamix-fmi-course-2024/web-development-with-java-lab/tree/main/lab04/spring-initializr-tutorial.md)</pre></big>
```
